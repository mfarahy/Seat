...
namespace Seat.SeatEngine.DataProvider.Tsetmc
{
    public class TsetmcDataRow
    {
        ...
        public TsetmcRowTypes Type
        {
            get
            {
                if (l18 != null && (l18.IndexOf("تسه") == 0 || l18.IndexOf("تملي") == 0))
                    return TsetmcRowTypes.HousingFacilities;

                if ((yval == "300" || yval == "303" || yval == "313") && (l18 == null || l18.IndexOf("تسه") != 0))
                    return TsetmcRowTypes.Saham;

                if (yval == "309")
                    return TsetmcRowTypes.PayeFarabourse;

                if (yval == "400" || yval == "403" || yval == "404")
                    return TsetmcRowTypes.HaghTaghaddom;

                if (yval == "306" || yval == "301" || yval == "706" || yval == "208")
                    return TsetmcRowTypes.OraghMosharekat;

                if (yval == "263")
                    return TsetmcRowTypes.Ati;

                if (yval == "305" || yval == "380")
                    return TsetmcRowTypes.Sandoogh;

                if (yval == "600" || yval == "602" || yval == "605" || yval == "311" || yval == "312")
                    return TsetmcRowTypes.EkhtiarForoush;

                if (yval == "308" || yval == "701")
                    return TsetmcRowTypes.Kala;

                return TsetmcRowTypes.unknown;
            }
        }
