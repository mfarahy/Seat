    ...
    public virtual bool SetValue(string propertyName, object value)
    {
       ...
       private ObjectChangeTracker _changeTracker;
        ...
        private void FixupInstrument(Instrument previousValue)
        {
            ...
            if (previousValue != null && previousValue.ClientTypes.Contains(this))
            {
                previousValue.ClientTypes.Remove(this);
            }
    
            if (Instrument != null)
            {
                if (!Instrument.ClientTypes.Contains(this))
                {
                    Instrument.ClientTypes.Add(this);
                }
