...
{
    public class TradeValidator : AzValidator<Trade>
        {
    	...
    	private void setBusinessRules()
    		{
    			...
    			{
    				SecurityRuleFor().OperationRequired("Trd.C");
    			});
    
    			RuleSet(Mode.OnBatchRead | Mode.OnSingleRead, () =>
    			{
    				SecurityRuleFor().OperationRequired("Trd.R");
    			});
    
    			RuleSet(Mode.OnUpdate, () =>
    			{
    				SecurityRuleFor().OperationRequired("Trd.U");
    			});
    
    			RuleSet(Mode.OnDelete, () =>
    			{
    				SecurityRuleFor().OperationRequired("Trd.D");
    			});
    		}
        }
