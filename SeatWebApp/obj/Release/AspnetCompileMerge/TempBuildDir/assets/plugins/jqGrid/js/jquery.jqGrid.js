    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        return this.each(function() {
            if (!this.grid) {
                ...
                var
                v = $("<div " + k(l, "entrieBox", !1, "ui-jqgrid") + "></div>");
                $(v).attr({
                    id: "gbox_" + this.id,
                    dir: h
                    ...
                    y = function(a, b) {
                        ...
                        if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            if (Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q) {
                                e && (T *= e + 1);
                                var
                                V, W = $.isFunction(d.p.afterInsertRow),
                                    X = !1,
                                ...
                                for (d.p.grouping && (X = d.p.groupingView.groupCollapse === !0, V = $.jgrid.getMethod("groupingPrepare")); Q > R;) {
                                    ...
                                    if (L.push(""), B && L.push(E(0, R, d.p.page, d.p.rowNum, Z)), z && L.push(D(u, B, R, !1, _)), A && L.push(p.call(w, z + B, R + b)), i.repeatitems) {
                                        s || (s = G(z + A + B));
                                        var
                                        bb = $.jgrid.getXmlData(t, i.cell, !0);
                                        $.each(s, function(a) {
                                            var
                                            c = bb[this];
                            ...
                            if (d.p.reccount = x, d.p.treeANode = -1, d.p.userDataOnFooter && w.jqGrid("footerData", "set", d.p.userData, !0), g && (d.p.records = Q, d.p.lastpage = Math.ceil(Q / T)), c || d.updatepager(!1, !0), g) {
                                for (; Q > x;) {
                                    if (t = O[x], u = r(t, x + U), u = d.p.idPrefix + u, i.repeatitems) {
                                        s || (s = G(z + A + B));
                                        var
                                        eb = $.jgrid.getXmlData(t, i.cell, !0);
                                        $.each(s, function(a) {
                                            var
                                            b = eb[this];
                        ...
                        if (a) {
                            ...
                            for (d.p.grouping && (ab = d.p.groupingView.groupCollapse === !0, Y = $.jgrid.getMethod("groupingPrepare")); t > o;) {
                                if (q = u[o], x = $.jgrid.getAccessor(q, v), void 0 === x && ("number" == typeof v && null != d.p.colModel[v + J + L + M] && (x = $.jgrid.getAccessor(q, d.p.colModel[v + J + L + M].name)), void 0 === x && (x = W + o, 0 === I.length && g.cell))) {
                                    var
                                    eb = $.jgrid.getAccessor(q, g.cell) || q;
                                    x = null != eb && void
                                    0 !== eb[v] ? eb[v] : x, eb = null
                                }
                            ...
                            if (d.p.reccount = B, d.p.treeANode = -1, d.p.userDataOnFooter && A.jqGrid("footerData", "set", d.p.userData, !0), j && (d.p.records = t, d.p.lastpage = Math.ceil(t / V)), c || d.updatepager(!1, !0), j) {
                                for (; t > B && u[B];) {
                                    if (q = u[B], x = $.jgrid.getAccessor(q, v), void 0 === x && ("number" == typeof v && null != d.p.colModel[v + J + L + M] && (x = $.jgrid.getAccessor(q, d.p.colModel[v + J + L + M].name)), void 0 === x && (x = W + B, 0 === I.length && g.cell))) {
                                        var
                                        ib = $.jgrid.getAccessor(q, g.cell) || q;
                                        x = null != ib && void
                                        0 !== ib[v] ? ib[v] : x, ib = null
                                    }
                                    if (q) {
                        ...
                        if ($.isArray(d.p.data)) {
                            ...
                            }), d.p.multiSort && (g = s, h = t), d.p.treeGrid && d.p._sort) return void
                            ...
                            if (d.p.ignoreCase && (q = q.ignoreCase()), d.p.search === !0) {
                                ...
                                d.p.treeGrid && "nested" === d.p.treeGridModel && q.orderBy(d.p.treeReader.left_field, "asc", "integer", "", null); if (d.p.treeGrid && "adjacency" === d.p.treeGridModel && (m = 0, g = null), d.p.grouping)
                            ...
                            if ((d.p.search || d.p.resetsearch) && d.p.grouping && d.p.groupingView._locgr) {
                                ...
                                var
                                B, C, D, E = $.jgrid.getMethod("groupingPrepare");
                                if (d.p.footerrow && d.p.userDataOnFooter) {
                                    for (C in
                                        d.p.userData) d.p.userData.hasOwnProperty(C) && (d.p.userData[C] = 0);
                                    D = !0
                                }
                                for (B = 0; x > B; B++) {
                                    if (D)
                                        for (C in
                                            d.p.userData) d.p.userData.hasOwnProperty(C) && (d.p.userData[C] += parseFloat(v[B][C] || 0));
                                    E.call($(d), v[B], B, w)
                                }
                            }
                        ...
                        if (!d.grid.hDiv.loading) {
                            ...
                            switch (b = d.p.datatype.toLowerCase()) {
                                ...
                                case "script":
                                    $.ajax($.extend({
                                        ...
                                        success: function (c, f, g) {
                                            var bpr = $.isFunction(d.p.beforeProcessing) && d.p.beforeProcessing.call(d, c, f, g) === !1;
                                            
                                            return bpr ?
                                                void Q() :
                                                ("xml" === b ? L(c, o, a > 1, j) : M(c, o, a > 1, j), $(d).triggerHandler("jqGridLoadComplete", [c]), i && i.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), e && d.grid.populateVisible(), (d.p.loadonce || d.p.treeGrid) && (d.p.datatype = "local"), c = null, void (1 === a && Q()))
                                        },
                                ...
                                case "xmlstring":
                                    P(), c = "string" != typeof
                                    d.p.datastr ? d.p.datastr : $.parseXML(d.p.datastr), L(c), $(d).triggerHandler("jqGridLoadComplete", [c]), h && d.p.loadComplete.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), d.p.datatype = "local", d.p.datastr = null, Q();
                                    break;
                                case "jsonstring":
                                    P(), c = "string" == typeof
                                    d.p.datastr ? $.jgrid.parse(d.p.datastr) : d.p.datastr, M(c), $(d).triggerHandler("jqGridLoadComplete", [c]), h && d.p.loadComplete.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), d.p.datatype = "local", d.p.datastr = null, Q();
                                    break;
                                case "local":
                                case "clientside":
                        ...
                        var
                        h = s.indexOf(c); - 1 === h ? (s.push(c), t.push(g)) : g ? t[h] = g : (t.splice(h, 1), s.splice(h, 1)), d.p.sortorder = "", d.p.sortname = "";
                ...
                for (this.p.id = this.id, -1 === $.inArray(d.p.multikey, x) && (d.p.multikey = !1), d.p.keyName = !1, i = 0; i < d.p.colModel.length; i++) w = "string" == typeof
                d.p.colModel[i].template ? null != $.jgrid.cmTemplate && "object" == typeof
                $.jgrid.cmTemplate[d.p.colModel[i].template] ? $.jgrid.cmTemplate[d.p.colModel[i].template] : {} : d.p.colModel[i].template, d.p.colModel[i] = $.extend(!0, {}, d.p.cmTemplate, w || {}, d.p.colModel[i]), d.p.keyName === !1 && d.p.colModel[i].key === !0 && (d.p.keyName = d.p.colModel[i].name);
                ...
                var
                bb, cb, db, eb, fb, gb, hb, ib, jb = "<thead><tr class='ui-jqgrid-labels' role='row'>",
                    kb = "",
                    lb = "",
                    mb = "";
                ...
                for (i = 0; i < this.p.colNames.length; i++) {
                    var
                    nb = d.p.headertitles ? ' title="' + $.jgrid.stripHtml(d.p.colNames[i]) + '"' : "";
                    jb += "<th id='" + d.p.id + "_" + d.p.colModel[i].name + "' role='columnheader' " + k(l, "headerBox", !1, "ui-th-column ui-th-" + h) + " " + nb + ">", cb = d.p.colModel[i].index || d.p.colModel[i].name, jb += "<div id='jqgh_" + d.p.id + "_" + d.p.colModel[i].name + "' " + bb + ">" + d.p.colNames[i], d.p.colModel[i].width = d.p.colModel[i].width ? parseInt(d.p.colModel[i].width, 10) : 150, "boolean" != typeof
                    d.p.colModel[i].title && (d.p.colModel[i].title = !0), d.p.colModel[i].lso = "", cb === d.p.sortname && (d.p.lastsort = i), d.p.multiSort && (u = $.inArray(cb, s), -1 !== u && (d.p.colModel[i].lso = t[u])), jb += ib + "</div></th>"
                }
                ...
                if (d.p.disableClick = !1, $("th", sb).each(function(a) {
                    db = d.p.colModel[a].width, void
                    0 === d.p.colModel[a].resizable && (d.p.colModel[a].resizable = !0), d.p.colModel[a].resizable ? (eb = document.createElement("span"), $(eb).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h).css("cursor", "col-resize"), $(this).addClass(d.p.resizeclass)) : eb = "", $(this).css("width", db + "px").prepend(eb), eb = null;
                    var
                    b = "";
                    d.p.colModel[a].hidden && ($(this).css("display", "none"), b = "display:none;"), tb += "<td role='gridcell' style='height:0px;width:" + db + "px;" + b + "'></td>", e.headers[a] = {
                        width: db,
                        el: this
                    }, kb = d.p.colModel[a].sortable, "boolean" != typeof
                    kb && (d.p.colModel[a].sortable = !0, kb = !0);
                    var
                ...
                var
                vb = $("<table " + k(l, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(jb),
                ...
                $(d).before(e.hDiv).click(function(a) {
                    ...
                    if (c = c === !1 || "stop" === c ? !1 : !0, $.isFunction(d.p.beforeSelectRow)) {
                        var
                        e = d.p.beforeSelectRow.call(d, gb[0].id, a);
                        (e === !1 || "stop" === e) && (c = !1)
                    }
                    ...
                    if (fb = a.target, gb = $(fb, d.rows).closest("tr.jqgrow"), 0 !== $(gb).length) {
                        ...
                        var
                        b = $(d).triggerHandler("jqGridDblClickRow", [$(gb).attr("id"), yb, zb, a]);
                        return null != b ? b : $.isFunction(d.p.ondblClickRow) && (b = d.p.ondblClickRow.call(d, $(gb).attr("id"), yb, zb, a), null != b) ? b : void
                        0
                    }
                    ...
                    if (fb = a.target, gb = $(fb, d.rows).closest("tr.jqgrow"), 0 !== $(gb).length) {
                        ...
                        var
                        b = $(d).triggerHandler("jqGridRightClickRow", [$(gb).attr("id"), yb, zb, a]);
                        return null != b ? b : $.isFunction(d.p.onRightClickRow) && (b = d.p.onRightClickRow.call(d, $(gb).attr("id"), yb, zb, a), null != b) ? b : void
                        0
                    }
                ...
                var
                Bb = q + " " + k(l, "icon_caption_open", !0),
                    Cb = q + " " + k(l, "icon_caption_close", !0);
                e.cDiv = document.createElement("div");
                var
                Db = d.p.hidegrid === !0 ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + p + "' title='" + ($.jgrid.getRegional(d, "defaults.showhide", d.p.showhide) || "") + "' />").hover(function() {
                    Db.addClass(o)
                }, function() {
                    Db.removeClass(o)
                ...
                if ($(e.cDiv).append(Db).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl" : "") + " " + k(l, "gridtitleBox", !0)), $(e.cDiv).insertBefore(e.hDiv), d.p.toolbar[0]) {
                    var
                    Eb = k(l, "customtoolbarBox", !0, "ui-userdata");
                ...
                if (d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager", e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0], d.p.toppager = "#" + d.p.toppager, $(e.topDiv).addClass(k(l, "toppagerBox", !0, "ui-jqgrid-toppager")).width(e.width).insertBefore(e.hDiv), T(d.p.toppager, "_t")), d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], xb = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"), $(e.sDiv).append(xb).width(e.width).insertAfter(e.hDiv), $(xb).append(rb), e.footers = $(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells, d.p.rownumbers && (e.footers[0].className = k(l, "rownumBox", !0, "jqgrid-rownum")), wb && $(e.sDiv).hide()), xb = null, d.p.caption) {
                    ...
                    $(e.cDiv).hide(), d.p.toppager || $(e.hDiv).addClass(k(d.p.styleUI + ".common", "cornertop", !0)); if ($(e.hDiv).after(e.bDiv).mousemove(function(a) {
        ...
        resizeColumn: function(a, b) {
            return this.each(function() {
                ...
                if ("string" == typeof a) {
                    ...
                    a = parseInt(a, 10); if (b = parseInt(b, 10), !("number" != typeof a || 0 > a || a > h.length - 1 || "number" != typeof b || b < g.minColWidth)) {
                    if (g.forceFit)
...
! function(a) {
    ...
    a.extend(a.jgrid, {
        ...
        createModal: function(b, c, d, e, f, g, h) {
            ...
            } else(0 !== d.left || 0 !== d.top) && (q.left = d.left, q.top = d.top + "px"); if (a("a.ui-jqdialog-titlebar-close", n).click(function() {
                var
                    ...
                    if (c.multiple === !0 ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
                        ...
                        i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
                            ...
                            success: function(b) {
                                ...
                                "string" == typeof
                                m && (m = a(a.trim(m)).html()), m && (a(e).append(m), g(e, h, o ? ["postData"] : void 0), void 0 === h.size && (h.size = j ? 3 : 1), j ? (d = f.split(","), d = a.map(d, function(b) {
                                    return a.trim(b)
    ...
    a.jgrid.extend({
        editGridRow: function(c, d) {
            ...
            return d = a.extend(!0, {
                ...
                f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function(n) {
                        if (h = this.name, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && this.editable === !0 && "rn" !== h) {
                            ...
                            if (h === d.p.ExpandColumn && d.p.treeGrid === !0) k = a("td[role='gridcell']:eq(" + n + ")", d.rows[q]).text();
                            else {
                                try {
                            ...
                            if ("_empty" === c && u.defaultValue && (k = a.isFunction(u.defaultValue) ? u.defaultValue.call(r) : u.defaultValue), this.edittype || (this.edittype = "text"), r.p.autoencode && (k = a.jgrid.htmlDecode(k)), m = a.jgrid.createEl.call(r, this.edittype, u, k, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (k = a(m).val(), "select-multiple" === a(m).get(0).type && k && (k = k.join(","))), "checkbox" === this.edittype && (k = a(m).is(":checked") ? a(m).val() : a(m).attr("offval")), (b[r.p.id].checkOnSubmit || b[r.p.id].checkOnUpdate) && (b[r.p.id]._savedData[h] = k), a(m).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && a(m).addClass(g.inputClass), E) a(K).find("#" + h).replaceWith(m);
                                ...
                                if (j = a(e).find("tr[rowpos=" + w + "]"), v.rowabove) {
                                    var
                                    z = a("<tr><td class='contentinfo' colspan='" + 2 * f + "'>" + v.rowcontent + "</td></tr>");
                            ...
                            switch (r.p.autoencode && (g = a.jgrid.htmlDecode(g)), (b[r.p.id].checkOnSubmit === !0 || b[r.p.id].checkOnUpdate) && (b[r.p.id]._savedData[f] = g), f = a.jgrid.jqID(f), m[h].edittype) {
                                ...
                                case "checkbox":
                                    if (g = String(g), m[h].editoptions && m[h].editoptions.value) {
                                        ...
                                        g = g.toLowerCase(), g.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== g ? (a("#" + f, e)[r.p.useProp ? "prop" : "attr"]("checked", !0), a("#" + f, e)[r.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : (a("#" + f, e)[r.p.useProp ? "prop" : "attr"]("checked", !1), a("#" + f, e)[r.p.useProp ? "prop" : "attr"]("defaultChecked", !1));
                ...
                k() {
                    ...
                    q && "object" == typeof
                    q && (t = q), a.isFunction(b[r.p.id].beforeCheckValues) && (q = b[r.p.id].beforeCheckValues.call(r, t, a(x), v), q && "object" == typeof q && (t = q));
                    for (g in
                        t)
                    ...
                    if (j(), n[0] && (o = a(r).triggerHandler("jqGridAddEditClickSubmit", [b[r.p.id], t, v]), void 0 === o && a.isFunction(b[r.p.id].onclickSubmit) && (o = b[r.p.id].onclickSubmit.call(r, b[r.p.id], t, v) || {}), n = a(r).triggerHandler("jqGridAddEditBeforeSubmit", [t, a(x), v]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[r.p.id].beforeSubmit) && (n = b[r.p.id].beforeSubmit.call(r, t, a(x), v))), n[0] && !b[r.p.id].processing) {
                        if (b[r.p.id].processing = !0, a("#sData", z + "_2").addClass(h.active), m = b[r.p.id].url || a(r).jqGrid("getGridParam", "editurl"), f = p.oper, e = "clientArray" === m ? r.p.keyName : p.id, t[f] = "_empty" === a.trim(t[r.p.id + "_id"]) ? p.addoper : p.editoper, t[f] !== p.addoper ? t[e] = t[r.p.id + "_id"] : void 0 === t[e] && (t[e] = t[r.p.id + "_id"]), delete t[r.p.id + "_id"], t = a.extend(t, b[r.p.id].editData, o), r.p.treeGrid === !0) {
                            if (t[f] === p.addoper) {
                                ...
                                var
                                s = "adjacency" === r.p.treeGridModel ? r.p.treeReader.parent_id_field : "parent_id";
                                t[s] = k
                            }
                            for (l in
                                r.p.treeReader)
                        ...
                        y = a.extend({
                            ...
                            complete: function(g, j) {
                                var
                                l;
                                if (a("#sData", z + "_2").removeClass(h.active), t[e] = r.p.idPrefix + t[e], g.status >= 300 && 304 !== g.status ? (n[0] = !1, n[1] = a(r).triggerHandler("jqGridAddEditErrorTextFormat", [g, v]), n[1] = a.isFunction(b[r.p.id].errorTextFormat) ? b[r.p.id].errorTextFormat.call(r, g, v) : j + " Status: '" + g.statusText + "'. Error code: " + g.status) : (n = a(r).triggerHandler("jqGridAddEditAfterSubmit", [g, t, v]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[r.p.id].afterSubmit) && (n = b[r.p.id].afterSubmit.call(r, g, t, v))), n[0] === !1) a(".FormError", x).html(n[1]), a(".FormError", x).show();
                                else
                                if (r.p.autoencode && a.each(t, function(b, c) {
                                    ...
                                    for (l in
                                        b[r.p.id]._savedData) b[r.p.id]._savedData.hasOwnProperty(l) && t[l] && (b[r.p.id]._savedData[l] = t[l]);
                        ...
                        if (y.url || b[r.p.id].useDataProxy || (a.isFunction(r.p.dataProxy) ? b[r.p.id].useDataProxy = !0 : (n[0] = !1, n[1] += " " + F.nourl)), n[0])
                            if (b[r.p.id].useDataProxy) {
                                var
                                B = r.p.dataProxy.call(r, y, "set_" + r.p.id);
                                void
                                0 === B && (B = [!0, ""]), B[0] === !1 ? (n[0] = !1, n[1] = B[1] || "Error deleting the selected row!") : (y.data.oper === p.addoper && b[r.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(A.themodal), {
                                    gb: "#gbox_" + a.jgrid.jqID(w),
                                    jqm: d.jqModal,
                                    onClose: b[r.p.id].onClose,
                                    removemodal: b[r.p.id].removemodal,
                ...
                o(b, c) {
                    var
                    d = c[1].length - 1;
                    0 === b ? a("#pData", s).addClass(h.disabled) : void
                    ...
                    0 !== c[1][b + 1] && a("#" + a.jgrid.jqID(c[1][b + 1])).hasClass(h.disabled) ? a("#nData", s).addClass(h.disabled) : a("#nData", s).removeClass(h.disabled)
                }

                function
                p() {
                    var
                    b = a(r).jqGrid("getDataIDs"),
                        c = a("#id_g", z).val(),
                        d = a.inArray(c, b);
                    return [d, b]
                }
                ...
                if (r.grid && c) {
                    ...
                    s, t, u, v, w = r.p.id,
                        ...
                        D = 0,
                        E = "string" == typeof
                        b[r.p.id].template && b[r.p.id].template.length > 0,
                    ...
                    var
                    H, I = isNaN(b[a(this)[0].p.id].dataheight) ? b[a(this)[0].p.id].dataheight : b[a(this)[0].p.id].dataheight + "px",
                            ...
                            if (p = {}, a.isFunction(b[e.p.id].onclickSubmit) && (p = b[e.p.id].onclickSubmit.call(e, b[e.p.id], l) || {}), a.isFunction(b[e.p.id].beforeSubmit) && (g = b[e.p.id].beforeSubmit.call(e, l)), g[0] && !b[e.p.id].processing) {
                                ...
                                m = a.extend({
                                    ...
                                    complete: function(c, i) {
                                        var
                                        j;
                                        if (a("#dData", "#" + r + "_2").removeClass(h.active), c.status >= 300 && 304 !== c.status ? (g[0] = !1, g[1] = a.isFunction(b[e.p.id].errorTextFormat) ? b[e.p.id].errorTextFormat.call(e, c) : i + " Status: '" + c.statusText + "'. Error code: " + c.status) : a.isFunction(b[e.p.id].afterSubmit) && (g = b[e.p.id].afterSubmit.call(e, c, f)), g[0] === !1) a("#DelError>td", "#" + r).html(g[1]), a("#DelError", "#" + r).show();
                                        else {
        ...
        _buildNavMenu: function(b, c, d, e, f, g, h, i) {
            return this.each(function() {
                ...
                j = this,
                    k = j.p.styleUI,
                    l = (a.jgrid.styleUI[k].navigator, a.jgrid.styleUI[k].filter),
                    m = a.jgrid.styleUI[k].common,
                    n = "form_menu_" + a.jgrid.randId(),
                    o = "<button class='dropdownmenu " + m.button + "' value='" + n + "'>Actions</button>";
                a(b + "_" + d.position, b).append(o);
                var
                p = {
                    themodal: "alertmod_" + this.p.id,
                    modalhead: "alerthd_" + this.p.id,
                    modalcontent: "alertcnt_" + this.p.id
                        ...
                        var
                        b, k, o = a(".ui-jqgrid-view").css("font-size") || "11px",
                            q = a('<ul id="' + n + '" class="ui-nav-menu modal-content" role="menu" tabindex="0" style="display:none;font-size:' + o + '"></ul>');
                        d.add && (f = f || {}, b = f.id || "add_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.addtext || d.addtitle) + "</a></li>").click(function() {
                            return a(this).hasClass(m.disabled) || (a.isFunction(d.addfunc) ? d.addfunc.call(j) : a(j).jqGrid("editGridRow", "new", f), a(q).hide()), !1
                        }), a(q).append(k)), d.edit && (e = e || {}, b = e.id || "edit_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.edittext || d.edittitle) + "</a></li>").click(function() {
                            if (!a(this).hasClass(m.disabled)) {
                                var
                                b = j.p.selrow;
                                b ? a.isFunction(d.editfunc) ? d.editfunc.call(j, b) : a(j).jqGrid("editGridRow", b, e) : (a.jgrid.viewModal("#" + p.themodal, {
                                    gbox: "#gbox_" + a.jgrid.jqID(j.p.id),
                                    jqm: !0
                                }), a("#jqg_alrt").focus()), a(q).hide()
                            }
                            return !1
                        }), a(q).append(k)), d.view && (i = i || {}, b = i.id || "view_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.viewtext || d.viewtitle) + "</a></li>").click(function() {
                            if (!a(this).hasClass(m.disabled)) {
                                var
                                b = j.p.selrow;
                                b ? a.isFunction(d.editfunc) ? d.viewfunc.call(j, b) : a(j).jqGrid("viewGridRow", b, i) : (a.jgrid.viewModal("#" + p.themodal, {
                                    gbox: "#gbox_" + a.jgrid.jqID(j.p.id),
                                    jqm: !0
                                }), a("#jqg_alrt").focus()), a(q).hide()
                            }
                            return !1
                        }), a(q).append(k)), d.del && (g = g || {}, b = g.id || "del_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.deltext || d.deltitle) + "</a></li>").click(function() {
                            if (!a(this).hasClass(m.disabled)) {
                                var
                                b;
                                j.p.multiselect ? (b = j.p.selarrrow, 0 === b.length && (b = null)) : b = j.p.selrow, b ? a.isFunction(d.delfunc) ? d.delfunc.call(j, b) : a(j).jqGrid("delGridRow", b, g) : (a.jgrid.viewModal("#" + p.themodal, {
                                    gbox: "#gbox_" + a.jgrid.jqID(j.p.id),
                                    jqm: !0
                                }), a("#jqg_alrt").focus()), a(q).hide()
                            }
                            ...
                            return a(this).hasClass(m.disabled) || (a.isFunction(d.searchfunc) ? d.searchfunc.call(j, h) : a(j).jqGrid("searchGrid", h), a(q).hide()), !1
                        }), a(q).append(k), h.showOnLoad && h.showOnLoad === !0 && a(k).click()), d.refresh && (b = h.id || "search_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.refreshtext || d.refreshtitle) + "</a></li>").click(function() {
                            if (!a(this).hasClass(m.disabled)) {
                                ...
                                a.isFunction(d.afterRefresh) && d.afterRefresh.call(j), a(q).hide()
                            }
                            return !1
                        }), a(q).append(k)), a(q).hide(), a("body").append(q), a("#" + n).addClass("ui-menu " + l.menu_widget), a("#" + n + " > li > a").hover(function() {
                            a(this).addClass(m.hover)
                        }, function() {
                            a(this).removeClass(m.hover)
                        })
                    };
                q(), a(".dropdownmenu").on("click", function() {
                    var
                    b = a(this).offset(),
                        c = b.left,
                        d = parseInt(b.top),
                        e = a(this).val();
                    a("#" + e).show().css({
                        top: d - (a("#" + e).height() + 10) + "px",
                        left: c + "px"
                    })
                }), a("body").on("click", function(b) {
                    a(b.target).hasClass("dropdownmenu") || a("#" + n).hide()
                })
            })
        },
                    ...
                    this.onchange = function() {
                        ...
                        if (this.p.groupButton && (p = a("<input type='button' value='+ {}' title='Add subgroup' class='add-group " + j.button + "'/>"), p.bind("click", function() {
                            ...
                            r.bind("click", function() {
                                for (void 0 === b.rules && (b.rules = []), d = 0; d < f.p.columns.length; d++) {
                                    var
                                    c = void
                                    0 === f.p.columns[d].search ? !0 : f.p.columns[d].search,
                        ...
                        r.append(t), t.bind("change", function() {
                            ...
                            if (l) {
                                ...
                                var
                                c = a.jgrid.createEl.call(o, l.inputtype, l.searchoptions, "", !0, n.p.ajaxSelectOptions || {}, !0);
                                ...
                                if (a(".selectopts", k).empty().append(e), a(".selectopts", k)[0].selectedIndex = 0, a.jgrid.msie && a.jgrid.msiever() < 9) {
                                    var
                                    j = parseInt(a("select.selectopts", k)[0].offsetWidth, 10) + 1;
                        ...
                        for (d = 0; d < n.p.columns.length; d++) {
                            var
                            w = void
                            0 === n.p.columns[d].search ? !0 : n.p.columns[d].search,
        ...
        filterToolbar: function(b) {
            ...
            return b = a.extend({
                ...
                if (!d.p.filterToolbar) {
                    ...
                    var
                    e, f = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].filter,
                        ...
                        i = function() {
                            ...
                            for (var j, k, l = a(".ui-jqgrid-view").css("font-size") || "11px", m = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + l + ";left:" + e + "px;top:" + h + 'px;">', n = a(c).attr("soper"), o = [], p = 0, q = a(c).attr("colname"), r = d.p.colModel.length; r > p && d.p.colModel[p].name !== q;) p++;
                            var
                            s = d.p.colModel[p],
                                t = a.extend({}, s.searchoptions);
                            for (t.sopt || (t.sopt = [], t.sopt[0] = "select" === s.stype ? "eq" : b.defaultSearch), a.each(b.odata, function() {
                                o.push(this.oper)
                            }), p = 0; p < t.sopt.length; p++) k = a.inArray(t.sopt[p], o), -1 !== k && (j = n === b.odata[k].oper ? g.highlight : "", m += '<li class="ui-menu-item ' + j + '" role="presentation"><a class="' + g.cornerall + ' g-menu-item" tabindex="0" role="menuitem" value="' + b.odata[k].oper + '" oper="' + b.operands[b.odata[k].oper] + '"><table class="ui-common-table"><tr><td width="25px">' + b.operands[b.odata[k].oper] + "</td><td>" + b.odata[k].text + "</td></tr></table></a></li>");
                            m += "</ul>", a("body").append(m), a("#sopt_menu").addClass("ui-menu " + f.menu_widget), a("#sopt_menu > li > a").hover(function() {
                                a(this).addClass(g.hover)
                            }, function() {
                                a(this).removeClass(g.hover)
                            }).click(function() {
                                var
                                e = a(this).attr("value"),
                                    f = a(this).attr("oper");
                    ...
                    a.each(d.p.colModel, function(c) {
                        ...
                        if (this.hidden === !0 && a(t).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), g = a.extend({}, this.searchoptions || {}, {
                            ...
                            if (b.searchOperators) {
                                ...
                                l = null != g.searchtitle ? g.searchtitle : b.operandTitle, r = "<a title='" + l + "' style='padding-right: 0.5em;' soper='" + j + "' class='soptclass' colname='" + this.name + "'>" + s + "</a>"
                            }
                            switch (a("td:eq(0)", v).attr("colindex", c).append(r), void 0 === g.clearSearch && (g.clearSearch = !0), g.clearSearch ? (n = b.resetTitle || "Clear Search Value", a("td:eq(2)", v).append("<a title='" + n + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + b.resetIcon + "</a>")) : a("td:eq(2)", v).hide(), this.surl && (g.dataUrl = this.surl), o = "", g.defaultValue && (o = a.isFunction(g.defaultValue) ? g.defaultValue.call(d) : g.defaultValue), p = a.jgrid.createEl.call(d, this.stype, g, o, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), a(p).css({
                                width: "100%"
                    ...
                    }), this.p.filterToolbar = !0, this.triggerToolbar = i, this.clearToolbar = j, this.toggleToolbar = k
                }
            })
        },
...
! function(a) {
    ...
    a.jgrid.inlineEdit = a.jgrid.inlineEdit || {}, a.jgrid.extend({
        editRow: function(b, c, d, e, f, g, h, i, j) {
            ...
            return "object" === a.type(l[0]) ? k = l[0] : (void 0 !== c && (k.keys = c), a.isFunction(d) && (k.oneditfunc = d), a.isFunction(e) && (k.successfunc = e), void 0 !== f && (k.url = f), void 0 !== g && (k.extraparam = g), a.isFunction(h) && (k.aftersavefunc = h), a.isFunction(i) && (k.errorfunc = i), a.isFunction(j) && (k.afterrestorefunc = j)), k = a.extend(!0, {
                ...
                c, d, e, f, g, h, i = this,
                    j = 0,
                    l = null,
                    m = {}, n = a(this).jqGrid("getStyleUI", i.p.styleUI + ".inlinedit", "inputClass", !0);
                i.grid && (f = a(i).jqGrid("getInd", b, !0), f !== !1 && (h = a.isFunction(k.beforeEditRow) ? k.beforeEditRow.call(i, k, b) : void 0, void 0 === h && (h = !0), h && (e = a(f).attr("editable") || "0", "0" !== e || a(f).hasClass("not-editable-row") || (g = i.p.colModel, a('td[role="gridcell"]', f).each(function(e) {
                    ...
                    b.length > 0 && b.focus()
                }, 0)), k.keys === !0 && a(f).bind("keyup", function(c) {
                    if (27 === c.keyCode) {
        ...
        saveRow: function(b, c, d, e, f, g, h) {
            ...
            var
            w = a.jgrid.getRegional(this, "errors"),
            ...
            return this.each(function() {
                ...
                if (i.grid && i.p.cellEdit === !0) {
                    if (c = parseInt(c, 10), i.p.selrow = i.rows[b].id, i.p.knv || a(i).jqGrid("GridNav"), i.p.savedRow.length > 0) {
                        ...
                        }, 1); if (h = i.p.colModel[c], e = h.name, "subgrid" !== e && "cb" !== e && "rn" !== e) {
                    ...
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        ...
                        switch (k.edittype) {
                            ...
                            case "custom":
                                try {
                                    ...
                                    "e1" === q ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.nodefined, g.bClose, {
                                        styleUI: e.p.styleUI
                                    }) : "e2" === q ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.novalue, g.bClose, {
                                        styleUI: e.p.styleUI
                                    }) : a.jgrid.info_dialog(f.errcap, q.message, g.bClose, {
                                        styleUI: e.p.styleUI
                                    })
                                }
                        }
                        if (i !== e.p.savedRow[d].v) {
                            ...
                            if (t[0] === !0) {
                                ...
                                if (a.isFunction(e.p.beforeSubmitCell) && (u = e.p.beforeSubmitCell.call(e, e.rows[b].id, l, h, b, c), u || (u = {})), a("input.hasDatepicker", j).length > 0 && a("input.hasDatepicker", j).datepicker("hide"), "remote" === e.p.cellsubmit)
                                    if (e.p.cellurl) {
                                        var
                                        v = {};
                                        ...
                                        y = e.p.prmNames, w = y.id, x = y.oper, v[w] = a.jgrid.stripPref(e.p.idPrefix, e.rows[b].id), v[x] = y.editoper, v = a.extend(u, v), a(e).jqGrid("progressBar", {
                                            ...
                                            error: function(d, h, i) {
                                                a("#lui_" + a.jgrid.jqID(e.p.id)).hide(), e.grid.hDiv.loading = !1, a(e).triggerHandler("jqGridErrorCell", [d, h, i]), a.isFunction(e.p.errorCell) ? (e.p.errorCell.call(e, d, h, i), a(e).jqGrid("restoreCell", b, c)) : (a.jgrid.info_dialog(f.errcap, d.status + " : " + d.statusText + "<br/>" + h, g.bClose, {
                                                    styleUI: e.p.styleUI
                                                }), a(e).jqGrid("restoreCell", b, c))
                                            }
    ...
    a.jgrid.extend({
        setTreeNode: function(b, c) {
            return this.each(function() {
                ...
                if (d.grid && d.p.treeGrid)
                    for (var e, f, g, h, i, j, k, l, m = d.p.expColInd, n = d.p.treeReader.expanded_field, o = d.p.treeReader.leaf_field, p = d.p.treeReader.level_field, q = d.p.treeReader.icon_field, r = d.p.treeReader.loaded, s = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common; c > b;) {
                        var
                        t, u = a.jgrid.stripPref(d.p.idPrefix, d.rows[b].id),
                            v = d.p._index[u];
                        ...
                        0 !== k[r] && (k[r] = "true" === k[r] || k[r] === !0 ? !0 : !1), "true" === k[o] || k[o] === !0 ? (j += (void 0 !== k[q] && "" !== k[q] ? k[q] : d.p.treeIcons.leaf) + " tree-leaf treeclick", k[o] = !0, l = "leaf") : (k[o] = !1, l = ""), k[n] = ("true" === k[n] || k[n] === !0 ? !0 : !1) && (k[r] || void 0 === k[r]), j += k[n] === !1 ? k[o] === !0 ? "'" : d.p.treeIcons.plus + " tree-plus treeclick'" : k[o] === !0 ? "'" : d.p.treeIcons.minus + " tree-minus treeclick'", j += "></div></div>", a(d.rows[b].cells[m]).wrapInner("<span class='cell-wrapper" + l + "'></span>").prepend(j), g !== parseInt(d.p.tree_root_level, 10) && (t = a(d).jqGrid("isVisibleNode", k), t || a(d.rows[b]).css("display", "none")), a(d.rows[b].cells[m]).find("div.treeclick").bind("click", function(b) {
                            var
        ...
        getNodeChildren: function(b) {
            ...
            return this.each(function() {
                ...
                if (d.grid && d.p.treeGrid) switch (d.p.treeGridModel) {
                    ...
                    case "adjacency":
                        var
                        k = d.p.treeReader.parent_id_field,
        ...
        searchTree: function(b) {
            ...
            c, d, e, f = b.length || 0,
                ...
                i = [];
            return this.each(function() {
                if (this.grid && this.p.treeGrid && f)
                    for (d = this.p.localReader.id, c = 0; f > c; c++) g = a(this).jqGrid("getNodeAncestors", b[c]), g.length || g.push(b[c]), e = g[g.length - 1][d], -1 === a.inArray(e, h) && (h.push(e), g = a(this).jqGrid("getFullTreeNode", g[g.length - 1], !0), i = i.concat(g))
            }), i
        },
            ...
            return this.each(function() {
                ...
                if (g.grid && g.p.treeGrid) {
                    ...
                    if (void 0 !== k) {
                        ...
                        if (l.length > 0)
                            for (var m = 0; m < l.length; m++) l[m][h] !== b && a(g).jqGrid("delRowData", l[m][h]);
    ...
    a.assocArraySize = function(a) {
            ...
            return this.each(function() {
                ...
                o(b, c, d, e) {
                    ...
                    for (a.isArray(d) ? (k = d.length, o = d) : (k = 1, o[0] = d), h = [], i = [], h.root = 0, j = 0; k > j; j++) {
                        ...
                        p, q = [];
                        for (f = 0; l > f; f++) {
                            if (null == d) g = a.trim(c[f].member) + "_" + c[f].aggregator, p = g, o[0] = c[f].label || c[f].aggregator + " " + a.trim(c[f].member);
                            else {
                                p = d[j].replace(/\s+/g, "");
                                try {
                    ...
                    for (d in
                        ...
                        if (a.hasOwnProperty(d)) {
                            if ("object" != typeof a[d]) {
                                if ("level" === d) {
                                    if (void 0 === L[a.level] && (L[a.level] = "", a.level > 0 && "_r_Totals" !== a.text && (k[a.level - 1] = {
                                        useColSpanStyle: !1,
                                        groupHeaders: []
                            ...
                            if (null != a[d] && "object" == typeof a[d] && p(a[d]), "level" === d && a.level > 0 && a.level === (0 === u ? a.level : u)) {
                                c = 0;
                                for (b in
                                    a.fields)
                ...
                if (l.colTotals)
                    for (var P = f.length; P--;)
                        for (s = t; s < e.length; s++) O = e[s].name, g[O] ? g[O] += parseFloat(f[P][O] || 0) : g[O] = parseFloat(f[P][O] || 0);
                if (C > 0)
        ...
        jqPivot: function(b, c, d, e) {
            return this.each(function() {
                ...
                f(b) {
                    var
                    e, f = jQuery(g).jqGrid("pivotSetup", b, c),
                        h = a.assocArraySize(f.summary) > 0 ? !0 : !1,
                        i = a.jgrid.from.call(g, f.rows);
